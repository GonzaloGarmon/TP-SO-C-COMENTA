...
int admite_operacion_con_u32(char* nombre_interfaz, op_code codigo, uint32_t entero32, t_contexto* pid);
int admite_operacion_con_2u32(char* nombre_interfaz, op_code codigo, uint32_t primer_entero32, uint32_t segundo_entero32, t_contexto* pid);
int admite_operacion_con_string(char* nombre_interfaz, op_code codigo, char* palabra, t_contexto* pid);
int admite_operacion_con_string_u32(char* nombre_interfaz, op_code codigo, char* palabra, uint32_t primer_entero32, t_contexto* pid);
int admite_operacion_con_string_3u32(char* nombre_interfaz, op_code codigo,char* palabra, uint32_t primer_entero32, uint32_t segundo_entero32, uint32_t tercer_entero32,t_contexto* pid);
